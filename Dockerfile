...
RUN wget -O /custom.sh https://github.com/ramirezfx/opensuse-leap-kde-desktop-arm64/raw/main/custom.sh && chmod +x /custom.sh
RUN /custom.sh

# Add language-support:
RUN wget -O /tmp/languages.txt https://github.com/ramirezfx/opensuse-leap-kde-desktop-arm64/raw/main/lang-kde.txt && xargs -a /tmp/languages.txt zypper -n --no-gpg-checks in
